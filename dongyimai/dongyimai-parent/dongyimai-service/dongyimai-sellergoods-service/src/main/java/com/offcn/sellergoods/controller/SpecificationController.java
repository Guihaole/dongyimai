...
public class SpecificationController {
     ...
     * @param id
     * @return
     * http://localhost:9001/specification/36
     */
    ...
    @ApiImplicitParam(paramType = "path", name = "id", value = "主键ID", required = true, dataType = "Long")
    @PutMapping(value="/{id}")
    public Result update(@RequestBody @ApiParam(name = "Specification对象",value = "传入JSON数据",required = false)
                                     SpecEntity specEntity,@PathVariable Long id){
        //调用SpecificationService实现修改Specification
        specificationService.update(specEntity,id);
    ...
    @PostMapping
    public Result add(@RequestBody  @ApiParam(name = "Specification对象",value = "传入JSON数据",required = true)
     ...
     * @param id
     * @return
     * http://localhost:9001/specification/{id}
     */
    ...
    /**
     * http://localhost:9001/specification/selectOptions
     * @return
     */
