...
public class AddressServiceImpl extends ServiceImpl<AddressMapper, Address> implements AddressService {
    ...
    @Override
    public Result<List<Address>> findListByUserId(String username) {
        QueryWrapper<Address> addressQueryWrapper = new QueryWrapper<>();
        addressQueryWrapper.eq("user_id",username);
        List<Address> addressList = addressMapper.selectList(addressQueryWrapper);
        return new Result<List<Address>>(true, StatusCode.OK,"收获地址查询成功",addressList);
    }
}
