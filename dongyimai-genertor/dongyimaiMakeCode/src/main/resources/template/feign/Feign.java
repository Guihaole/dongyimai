...
public interface ${Table}Feign {
    ...
    Result<PageResult<${Table}>> findPage(@RequestBody(required = false) ${Table} ${table}, @PathVariable  int page, @PathVariable  int size);
    ...
    Result<PageResult<${Table}>> findPage(@PathVariable  int page, @PathVariable  int size);
